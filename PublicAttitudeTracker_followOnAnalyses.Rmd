...
demo.pred.ancestry.multi.religion.sensitivity <- c("Black_filter","Asian_filter",
                              "MARSTAT", "RELIGIOSITY", "RELIGION", "DEGREE",
                              "WorkingStatus_Binary")
```


### correlations between variables to select only one for each underlying trait

```{r correlate predictors}
corr
```
