...
minimum score = 0 (no volunteering in the past 4 weeks)
Maximum score = 3 (donated blood, donated money to charity, volunteered in the past 4 weeks)


###### next::: create summed scores and add them to the variable lists.
...
"DIGPROF_BANK", "DIGPROF_FORMS", "DIGPROF_HINFO", "DIGPROF_APPOINT", 
"DIGPROF_APP", "FINNOW", "RELIGIOSITY", "RELIGION", "QUALTYPE", 
...
"OCCUPATION_NSSEC", "TENURE", "LIFEEVENT", "PROSO_VOLUNTEER", 
"PROSO_DONATE", "PROSO_BLOOD", "PROSO_ORGAN", "PROSO_NONE", "PROSO4W_VOLUNTEER", 
"PROSO4W_DONATE", "PROSO4W_BLOOD", "PROSO4W_NONE", "DISABILITY", 
...
"DISABFAM", "AID", "HEALTH", "HRES_TRIAL", "HRES_FGROUP", "HRES_SURVEY", 
"HRES_NONE", "HRES_DK", "HACT12_1", "HACT12_2", "HACT12_3", "HACT12_4", 
"TRUSTGEN", "TRUSTORG_A", "TRUSTORG_B", "TRUSTORG_C", "TRUSTORG_D", 
"TRUSTORG_E", "SCIINT", "SCIINF", "SCITRU", "SCILIFE", "SCIBEN", 
...
"DIGPROF_BANK", "DIGPROF_FORMS", "DIGPROF_HINFO", "DIGPROF_APPOINT", 
"DIGPROF_APP", "FINNOW", "RELIGIOSITY", "RELIGION", 
"EDUCATION",  "WorkingStatus_Binary", "OCCUPATION_SOC2010", 
 "LIFEEVENT", "PROSO_VOLUNTEER", 
"PROSO_DONATE", "PROSO_BLOOD", "PROSO_ORGAN", "PROSO_NONE", "PROSO4W_VOLUNTEER", 
"PROSO4W_DONATE", "PROSO4W_BLOOD", "PROSO4W_NONE", "DISABILITY", 
"DISAB1", "DISAB2", "DISABEVER", "GENFAM", "GENTEST", "GENTEST_1", 
"GENTEST_2", "GENTEST_3", "GENTEST_4", "GENTEST_5", "GENTEST_5OPEN", 
...
## Summary tables
```{r tabular descriptions of variables}

factor_df %>%
  freq(OFHACT,plain.ascii = FALSE, style = "rmarkdown",     
     totals     = FALSE, 
     cumul      = FALSE)

rror in freq(., sum_score_cols) : NULL is either NULL or does not exist
> factor_df %>%
+ select(sum_score_cols) %>%
+ freq()
